...
function html(propAccessor, onfocusbinding, parameters) {
  return `
    ...
    <button data-bind="click: $root.resetBgimage.bind($element, '${propAccessor}', '${parameters}'), button: {icons: {primary: 'fas fa-eraser'}, text: false, label: $root.t('widget-bgimage-reset') }"></button>
  `
}
